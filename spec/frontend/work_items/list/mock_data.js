...
const makeFilteredTokens = ({ grouped }) => [
  ...
  { type: TOKEN_TYPE_TYPE, value: { data: '1', operator: OPERATOR_IS } },
  { type: TOKEN_TYPE_TYPE, value: { data: '2', operator: OPERATOR_IS } },
  { type: TOKEN_TYPE_TYPE, value: { data: '3', operator: OPERATOR_NOT } },
  { type: TOKEN_TYPE_TYPE, value: { data: '4', operator: OPERATOR_NOT } },
...
export const apiParams = {
  ...
  not: {
    ...
    releaseTag: ['v20', 'v30'],
    workItemTypeIds: ['gid://gitlab/WorkItems::Type/3', 'gid://gitlab/WorkItems::Type/4'],
...
export const savedViewFilterTokens = [
  ...
  { type: 'type', value: { data: '1', operator: '=' } },
  { type: 'my-reaction', value: { data: 'smile', operator: '!=' } },
  { type: 'health', value: { data: 'onTrack', operator: '!=' } },
  { type: 'weight', value: { data: '1', operator: '!=' } },
  { type: 'type', value: { data: ['2', '3'], operator: '!=' } },
