...
import PipelinesDashboardClickhouse from '~/ci/analytics/project_ci_cd_analytics/components/pipelines_dashboard_clickhouse.vue';
import {
  SOURCE_PUSH,
  BRANCH_ANY,
  DATE_RANGE_DEFAULT,
...
import getPipelineAnalyticsQuery from '~/ci/analytics/project_ci_cd_analytics/graphql/queries/get_pipeline_analytics.query.graphql';
