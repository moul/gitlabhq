...
Settings.cron_jobs['deploy_tokens_expiring_worker'] ||= {}
Settings.cron_jobs['deploy_tokens_expiring_worker']['cron'] ||= '0 1 * * *'
Settings.cron_jobs['deploy_tokens_expiring_worker']['job_class'] = 'DeployTokens::ExpiringWorker'
