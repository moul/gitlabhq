...
1. In the left sidebar, go to **Build** > **Pipelines**.
...
- In GitLab: In the left sidebar, select **Operate** > **Kubernetes clusters**.
...
1. In the left sidebar, select **Build** > **Pipelines** and select the most recent pipeline.
