...
With GitLab Duo Agentic Chat, you can have a conversation that includes multiple projects.
...
This context is less important when you use Agentic Chat because it autonomously searches,
