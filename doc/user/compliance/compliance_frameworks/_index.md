...
| Project pipelines not public                             | `project_pipelines_not_public`                             | Ensures that [project pipelines are not publicly visible](../../../ci/pipelines/settings.md). Does not consider the [project visibility](../../public_access.md). |
