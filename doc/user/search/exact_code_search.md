...
| `content:foo`        | `foo` in content of files. It accepts regex as well.    | `foo` in content of files. It accepts regex as well.    |
| `regex:foo\d`        | Performs regex search for `foo\d`                       | Performs regex search for `foo\d`                       |
