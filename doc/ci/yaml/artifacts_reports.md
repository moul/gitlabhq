...
The `browser_performance` report collects browser performance testing metrics as an artifact.
This artifact is a JSON file generated by the
[GitLab plugin for sitespeed.io](https://gitlab.com/gitlab-org/gl-performance).

GitLab displays the results in the merge request. For more information, see
[browser performance testing](../testing/browser_performance_testing.md).
