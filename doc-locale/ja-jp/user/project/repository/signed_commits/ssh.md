...
- OpenSSH 8.1以降。
  ...
  > [!note]OpenSSH 8.7には、壊れた署名機能があります。OpenSSH 8.7を使用している場合は、OpenSSH 8.8にアップグレードしてください。
...
- SSHキーを使用して[コミットに署名するようにGitを設定](#configure-git-to-sign-commits-with-your-ssh-key)済みである。
