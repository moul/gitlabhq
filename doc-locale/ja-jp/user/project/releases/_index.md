...
> [!warning]リリースに関連付けられたGitタグを削除すると、そのリリースも削除されます。
...
> [!note]サブグループのプロジェクトリリースを親グループのマイルストーンに関連付けることはできません。詳細については、イシュー#328054[リリースをスーパーグループマイルストーンに関連付けることができない](https://gitlab.com/gitlab-org/gitlab/-/issues/328054)を参照してください。
