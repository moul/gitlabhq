...
> [!note]オフラインライセンスを持つGitLab Self-Managedインスタンスの場合、GitLab Duo Agent Platformの機能のモデルを変更するには、[GitLab Duo Agent Platform Self-Hosted](../../subscriptions/subscription-add-ons.md)アドオンが必要です。
