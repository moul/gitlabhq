...
# AGENTS.md and CLAUDE.md are excluded because they follow the AI agent convention of uppercase filenames
FILENAMES_WITH_UPPERCASE=$(find doc -type f -name "*[[:upper:]]*.md" ! -name "AGENTS.md" ! -name "CLAUDE.md")
